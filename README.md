...
基于 MuJoCo 物理仿真的机械臂智能分拣系统。从感知到决策到执行，完整展示 **YOLO 目标检测 → 逆运动学求解 → 抓取放置 → LLM 自然语言控制** 的全流程，并进一步用 **强化学习 + 行为克隆** 提升抓取鲁棒性。

## 项目阶段

| 阶段 | 内容 | 状态 |
|------|------|------|
| [01 机械臂硬件与驱动](01_机械臂硬件与驱动) | SO-100 机械臂硬件接口 | ✓ |
| [02 运动学与控制](02_运动学与控制) | 正/逆运动学、PD 控制 | ✓ |
| [03 感知与智能](03_感知与智能) | YOLO 视觉、感知 pipeline | ✓ |
| [04 自主决策与学习](04_自主决策与学习) | LLM 任务规划 + 脚本式抓取（结构详见 [04/README](04_自主决策与学习/README.md)，详细文档亦在本 README 下半段） | ✓ |
