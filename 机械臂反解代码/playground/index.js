...
// 导入控制工具函数
import { setupKeyboardControls, setupCartesianControls, setupControlPanel } from './robotControls.js';
...
function init() {
  ...
  function loadModelFromHash() {
    ...
    manager.onLoad = () => {
      ...
      // Initialize cartesian end-effector controls
      cartesianUpdate = setupCartesianControls(window.robot);
    };
  }
...
function render() {
  ...
  // Update cartesian end-effector control
  if (cartesianUpdate) {
    cartesianUpdate();
  }
